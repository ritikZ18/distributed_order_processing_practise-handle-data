...
# Mandatory flags for Spark + Java 17
SPARK_JVM_OPTS="--add-opens=java.base/java.lang=ALL-UNNAMED \
...
nohup env MAVEN_OPTS="$SPARK_JVM_OPTS" mvn -pl processor exec:java -Dexec.mainClass="com.platform.processor.SparkAnalyticsJob" > processor.log 2>&1 &
echo $! > .processor.pid
